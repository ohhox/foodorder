<h3>รายการครัวอาหาร</h3>

<form class="form-inline" method="POST">
    <div class="form-group">
        <label for="kitchen_name"> เพิ่มครัวอาหาร </label>
        <input type="text" class="form-control" name="kitchen_name" id="kitchen_name" placeholder="ชื่อครัว">
    </div> 
