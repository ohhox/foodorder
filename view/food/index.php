                    ...
                    foreach ($values as $keyx => $valuex) {
                        ...
                        <li class="FoodList T<?= $valuex['food_type_id'] ?>">
                            <div class="inner">
                                ...
                                <div class="control">
                                    <a href="<?= URL ?>food/food_form/<?= $valuex['fid'] ?>" class=" btn-xs  " title="แก้ไข"><i class="fa fa-pencil"></i></a>
                                    <a data-href="<?= URL ?>food/removeFood/<?= $valuex['fid'] ?>"  class="removeFood btn-xs" title="ลบ"><i class="fa fa-remove"></i></a>
                                </div>
